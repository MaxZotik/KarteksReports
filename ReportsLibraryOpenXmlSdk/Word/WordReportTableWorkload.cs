    ...
    public class WordReportTableWorkload
    {
        ...
        private void EditCellsTable()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                textXmovePlus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisXmovePlus}";
                ...
                textXspeedPlus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisXspeedPlus}";
                ...
                textXacceleratePlus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisXacceleratePlus}";
                ...
                textXmoveMinus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisXmoveMinus}";
                ...
                textXspeedMinus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisXspeedMinus}";
                ...
                textXaccelerateMinus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisXaccelerateMinus}";
                ...
                textYmovePlus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisYmovePlus}";
                ...
                textYspeedPlus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisYspeedPlus}";
                ...
                textYacceleratePlus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisYacceleratePlus}";
                ...
                textYmoveMinus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisYmoveMinus}";
                ...
                textYspeedMinus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisYspeedMinus}";
                ...
                textYaccelerateMinus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisYaccelerateMinus}";
                ...
                textZmovePlus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisZmovePlus}";
                ...
                textZspeedPlus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisZspeedPlus}";
                ...
                textZacceleratePlus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisZacceleratePlus}";
                ...
                textZmoveMinus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisZmoveMinus}";
                ...
                textZspeedMinus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisZspeedMinus}";
                ...
                textZaccelerateMinus.Text = @$"{_repositoryArchivePointWorkload.ArrayObjects[i].AxisZaccelerateMinus}";
