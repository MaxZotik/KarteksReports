    ...
    public class WordReportTableExamined
    {
        ...
        private void EditCellsTable()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                textXmovePlus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisXmovePlus}";
                ...
                textXspeedPlus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisXspeedPlus}";
                ...
                textXacceleratePlus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisXacceleratePlus}";
                ...
                textXmoveMinus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisXmoveMinus}";
                ...
                textXspeedMinus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisXspeedMinus}";
                ...
                textXaccelerateMinus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisXaccelerateMinus}";
                ...
                textYmovePlus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisYmovePlus}";
                ...
                textYspeedPlus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisYspeedPlus}";
                ...
                textYacceleratePlus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisYacceleratePlus}";
                ...
                textYmoveMinus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisYmoveMinus}";
                ...
                textYspeedMinus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisYspeedMinus}";
                ...
                textYaccelerateMinus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisYaccelerateMinus}";
                ...
                textZmovePlus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisZmovePlus}";
                ...
                textZspeedPlus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisZspeedPlus}";
                ...
                textZacceleratePlus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisZacceleratePlus}";
                ...
                textZmoveMinus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisZmoveMinus}";
                ...
                textZspeedMinus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisZspeedMinus}";
                ...
                textZaccelerateMinus.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].AxisZaccelerateMinus}";
