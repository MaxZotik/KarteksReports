...
{
    public class WordReportTableExamined
    {
        Template _template;
        RepositoryArchivePointExamined _repositoryArchivePointExamined;

        public WordReportTableExamined(Template templateExamined, RepositoryArchivePointExamined repositoryArchivePointExamined) 
        { 
            _template = templateExamined;
            _repositoryArchivePointExamined = repositoryArchivePointExamined;
        ...
        private void AddRowsTable()
        {
            ...
            int count = _repositoryArchivePointExamined.ArrayObjects.Count - 1;
        ...
        private void EditCellsTable()
        {
            ...
            int count = _repositoryArchivePointExamined.ArrayObjects.Count;
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                textXmovePlus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisXmovePlus, 2)}";
                ...
                textXspeedPlus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisXspeedPlus, 2)}";
                ...
                textXacceleratePlus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisXacceleratePlus, 2)}";
                ...
                textXmoveMinus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisXmoveMinus, 2)}";
                ...
                textXspeedMinus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisXspeedMinus, 2)}";
                ...
                textXaccelerateMinus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisXaccelerateMinus, 2)}";
                ...
                textYmovePlus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisYmovePlus, 2)}";
                ...
                textYspeedPlus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisYspeedPlus, 2)}";
                ...
                textYacceleratePlus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisYacceleratePlus, 2)}";
                ...
                textYmoveMinus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisYmoveMinus, 2)}";
                ...
                textYspeedMinus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisYspeedMinus, 2)}";
                ...
                textYaccelerateMinus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisYaccelerateMinus, 2)}";
                ...
                textZmovePlus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisZmovePlus, 2)}";
                ...
                textZspeedPlus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisZspeedPlus, 2)}";
                ...
                textZacceleratePlus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisZacceleratePlus, 2)}";
                ...
                textZmoveMinus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisZmoveMinus, 2)}";
                ...
                textZspeedMinus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisZspeedMinus, 2)}";
                ...
                textZaccelerateMinus.Text = @$"{Math.Round(_repositoryArchivePointExamined.ArrayObjects[i].AxisZaccelerateMinus, 2)}";
        ...
        private void EditPointTable()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                text.Text = @$"{_repositoryArchivePointExamined.ArrayObjects[i].Point}";
